        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!isRegistered()) {
                    ...
                    //displaying a toast
                    Toast.makeText(NotificationActivity.this, "Already registered...", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response.trim().equalsIgnoreCase("success")) {
                            ...
                            Toast.makeText(NotificationActivity.this, "Registered successfully", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(NotificationActivity.this, "Choose a different email", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
