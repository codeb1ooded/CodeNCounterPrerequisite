...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //Below is the link to basic scrolling tchniques and explanation of the code snippets that are used in this Project
        //https://github.com/ksoichiro/Android-ObservableScrollView/blob/master/docs/basic/index.md
...
//        ArrayAdapter<Filter> dataAdapter=new ArrayAdapter<Filter>(this,android.R.layout.simple_spinner_item,Filter.values());
...
//        spinner.setAdapter(dataAdapter);
    ...
    private class FilterAdapter extends ArrayAdapter<Filter> {
        public FilterAdapter(Context context) {
            ...
            //Link of how to customize spinner:http://stackoverflow.com/questions/9476665/how-to-change-spinner-text-size-and-text-color
            super(context, android.R.layout.simple_spinner_item, Filter.values());
            //setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            setDropDownViewResource(R.layout.spinner_dropdown_item);//Customize Spinner dropdown item layout.
        }
    }
}
